...
const OurServicesSection = () => {
 ...
 <section className="py-28 px-5 bg-gradient-to-b from-[#0b001a] via-[#14002b] to-[#0b001a] text-white">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-cyan-500 text-transparent bg-clip-text">
          About Brave BPO
        </h2>
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 text-left">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:shadow-xl transition-all duration-300">
            <h3 className="text-xl font-semibold mb-3 text-white">Core Strengths</h3>
            <p className="text-gray-300">
        ...
        <div className="mt-20 text-left max-w-4xl mx-auto">
          <h3 className="text-3xl font-bold mb-4">Why Brave BPO Stands Out</h3>
          ...
          <h4 className="text-2xl font-semibold mt-8 mb-4">Key Operational Verticals</h4>
